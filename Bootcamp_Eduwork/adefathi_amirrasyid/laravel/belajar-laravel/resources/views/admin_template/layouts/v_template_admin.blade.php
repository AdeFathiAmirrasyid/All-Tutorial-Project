                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        <div class="user-panel ">
                            <div class="image">
                                <img src="{{ asset('AdminLTE-tamplate/dist/img/profil.jpg') }}" class="img-circle "
                                    alt="User Image">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <div class="dropdown-item p-3  bg-primary text-white">
                            <div class="d-flex justify-content-center mb-2">
                                <img src="{{ asset('AdminLTE-tamplate/dist/img/profil.jpg') }}" alt="User Image"
    ...
    @section('sidebar')
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 ">
            ...
            <a href="#" class="brand-link">
                <img src="{{ asset('AdminLTE-tamplate/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo"
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('AdminLTE-tamplate/dist/img/profil.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                     ...
                     with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/dashboard/product') }}" class="nav-link">
                                <img src="{{ asset('AdminLTE-tamplate/dist/img/product.png') }}" alt=""
                                    width="18px">
